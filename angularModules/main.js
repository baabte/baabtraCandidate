...
angular.module('baabtra')  
  .controller('MainCtrl', ['$scope', '$translate', '$localStorage', '$window', '$rootScope', '$modal', 'commonSrv', 'bbConfig', '$state' ,'userProfile','$location',
    function ($scope,   $translate,   $localStorage,   $window, $rootScope , $modal , commonSrv , bbConfig, $state,userProfile,$location) {
      ...
      if($window.location.host.split(".").length > 2){
        var checkDomainExitsResponse = commonSrv.fnCheckDomainExits("");
